 ...
 * @Description:解决并发线程不安全，使用synchronized
 * @Author:coderDianxia
 * @Date: 2022/11/9 9:52
 */
public class Simpledateformat04Test {
    //同时运行的线程数
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            System.out.println("任务并发结束:使用synchronized耗时"+ TimeUnit.NANOSECONDS.toMillis(end-start)+"毫秒");
        } catch (InterruptedException e) {
            e.printStackTrace();
            System.exit(1);
        }
